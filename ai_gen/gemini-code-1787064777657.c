...
/* =========================================================================
 * MCP2515 Control Register Map (Addresses 0x00 - 0x7F)
...
#define MCP_TXRTSCTRL       0b00001101  /* TXnRTS Pin Control and Status */
 ...
 * ------------------------------------------------------------------------- */
#define MCP_RXF3SIDH        0b00010000  /* Filter 3 Standard Identifier High */
#define MCP_RXF3SIDL        0b00010001  /* Filter 3 Standard Identifier Low */
#define MCP_RXF3EID8        0b00010010  /* Filter 3 Extended Identifier High */
#define MCP_RXF3EID0        0b00010011  /* Filter 3 Extended Identifier Low */
#define MCP_RXF4SIDH        0b00010100  /* Filter 4 Standard Identifier High */
#define MCP_RXF4SIDL        0b00010101  /* Filter 4 Standard Identifier Low */
#define MCP_RXF4EID8        0b00010110  /* Filter 4 Extended Identifier High */
#define MCP_RXF4EID0        0b00010111  /* Filter 4 Extended Identifier Low */
#define MCP_RXF5SIDH        0b00011000  /* Filter 5 Standard Identifier High */
#define MCP_RXF5SIDL        0b00011001  /* Filter 5 Standard Identifier Low */
#define MCP_RXF5EID8        0b00011010  /* Filter 5 Extended Identifier High */
#define MCP_RXF5EID0        0b00011011  /* Filter 5 Extended Identifier Low */
 ...
 * ------------------------------------------------------------------------- */
#define MCP_RXM0SIDH        0b00100000  /* Mask 0 Standard Identifier High */
#define MCP_RXM0SIDL        0b00100001  /* Mask 0 Standard Identifier Low */
#define MCP_RXM0EID8        0b00100010  /* Mask 0 Extended Identifier High */
#define MCP_RXM0EID0        0b00100011  /* Mask 0 Extended Identifier Low */
#define MCP_RXM1SIDH        0b00100100  /* Mask 1 Standard Identifier High */
#define MCP_RXM1SIDL        0b00100101  /* Mask 1 Standard Identifier Low */
#define MCP_RXM1EID8        0b00100110  /* Mask 1 Extended Identifier High */
#define MCP_RXM1EID0        0b00100111  /* Mask 1 Extended Identifier Low */
#define MCP_CNF3            0b00101000  /* Configuration Register 3 */
#define MCP_CNF2            0b00101001  /* Configuration Register 2 */
#define MCP_CNF1            0b00101010  /* Configuration Register 1 */
